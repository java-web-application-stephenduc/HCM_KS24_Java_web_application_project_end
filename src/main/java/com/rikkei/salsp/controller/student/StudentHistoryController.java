...
/**
 * Controller hiển thị lịch sử cố vấn học tập và quản lý các yêu cầu mượn thiết bị của sinh viên.
 */
@Controller
...
public class StudentHistoryController {
    ...
    public String showBorrowForm(@PathVariable Long id, Authentication authentication, Model model, RedirectAttributes flash) {
        if (authentication == null || authentication.getName() == null) {
            return "redirect:/auth/login";
        }
        try {
